...
const products = [
  { id: 1, name: "Brow Pigment — Warm Brown", price: 49, category: "Pigments", desc: "Long-lasting warm brown pigment for natural brow enhancement.", color: "#c4a882" },
  { id: 2, name: "Brow Pigment — Ash Taupe", price: 49, category: "Pigments", desc: "Cool-toned ash taupe for soft, modern brows.", color: "#a89080" },
  { id: 3, name: "Lip Pigment — Nude Rose", price: 54, category: "Pigments", desc: "Delicate nude rose for natural lip blush results.", color: "#d4a0a0" },
  { id: 4, name: "Aftercare Healing Cream", price: 28, category: "Aftercare", desc: "Soothing cream for post-procedure care. Speeds up healing.", color: "#e8d5c4" },
  { id: 5, name: "Microblading Pen Set", price: 89, category: "Tools", desc: "Professional-grade microblading pens for precise hair strokes.", color: "#8a9090" },
  { id: 6, name: "Numbing Cream 30g", price: 35, category: "Accessories", desc: "Topical numbing cream for maximum client comfort.", color: "#c8d4d0" },
];
